...
public class incluirCab implements AcaoRotinaJava {
	...
	public void doAction(ContextoAcao contexto) throws Exception {
		...
		if (!query.next() || query.getInt("CONTADOR") == 0) {
			boolean update = nativeSql
					.executeUpdate(" UPDATE TGFCAB SET AD_STATUSEMAIL = 'S' WHERE NUNOTA = " + nuNota);
